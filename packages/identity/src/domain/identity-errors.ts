...
const safeMessages: Record<IdentityErrorCode, string> = {
  ...
  OTP_EXPIRED: 'Verification code is invalid.',
  OTP_CONSUMED: 'Verification code is invalid.',
  OTP_ATTEMPTS_EXCEEDED: 'Verification code is invalid.',
  OTP_RESEND_TOO_SOON: 'A new verification code cannot be requested yet.',
